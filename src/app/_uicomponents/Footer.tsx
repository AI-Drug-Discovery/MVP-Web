...
function Footer() {
  return (
    <Group gap={"40px"} justify="space-around" mt={"100px"} px="89px" py="40px" style={{ backgroundColor:"#AFB1B6"}} align="">
      <Stack>
        <Text w={506}  h={167}>
        ...
        <Group gap={"20px"}><InstagramLogo size={20}/><FacebookLogo size={20} /><TwitterLogo size={20}/> < LinkedinLogo size={20} /></Group>
      </Stack>
      <Stack gap={'10px'}>
        <Text fw={500}>Company</Text>
        <Text>Privavy Policy</Text>
        <Text>Terms & conditions</Text>
        <Text>Privavy & Breach Protocol</Text>
      </Stack>
      <Stack gap={'10px'}>
